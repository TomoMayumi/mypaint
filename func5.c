...
void freeHand(XEvent ev,Window *layer,Window *mask,int num);
void line(XEvent ev,Window *layer,Window *mask,int num);
void square(XEvent ev,Window *layer,Window *mask,int num);
void circle(XEvent ev,Window *layer,Window *mask,int num);
void fill(XEvent ev,Window *layer,Window *mask,int num);
...
void execFunc(XEvent ev,Window *layer,Window *mask,int num){

  switch(state){ // 選択されている動作の実行
  case FREEHAND://自由曲線
    freeHand(ev,layer,mask,num);
    break;
  case LINE://直線
    line(ev,layer,mask,num);
    break;
  case SQUARE://四角
    square(ev,layer,mask,num);
    break;
  case CIRCLE://丸
    circle(ev,layer,mask,num);
    break;
  case FILL://塗りつぶし
    fill(ev,layer,mask,num);
    break;
  default:
    break;
  }
...
void freeHand(XEvent ev,Window *layer,Window *mask,int num){
  ...
  addHistory(layer,mask,num);//履歴に追加
